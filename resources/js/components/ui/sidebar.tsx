      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Menu navigasi utama Amanpoll.</SheetDescription>
          </SheetHeader>
...
function SidebarContent({ className, onScroll, ref, ...props }: React.ComponentProps<'div'>) {
    ...
    const frameId = requestAnimationFrame(() => {
      ...
      if (active) {
        ...
        if (activeRect.top < containerRect.top) {
          container.scrollTop = Math.max(0, container.scrollTop - (containerRect.top - activeRect.top + 12));
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-muted ring-sidebar-ring flex h-7 shrink-0 items-center rounded-[6px] px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn('flex h-9 items-center gap-2 rounded-[7px] px-2', className)}
      {...props}
    >
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'data-[active=true]:bg-sidebar-aktif data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-[13px]',
        'group-data-[collapsible=icon]:hidden',
        className,
