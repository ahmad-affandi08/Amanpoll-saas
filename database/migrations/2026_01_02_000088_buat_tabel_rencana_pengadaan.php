...
return new class extends Migration
{
    ...
    {
        Schema::create('RencanaPengadaan', function (Blueprint $table): void {
            ...
            $table->unique(['OrganisasiId', 'Nomor'], 'UqRencanaPengadaanNomor');
    ...
    {
        Schema::dropIfExists('RencanaPengadaan');
    }
};
