...
use App\Domain\PerencanaanPengadaan\Http\Policies\PenerimaanPembelianPolicy;
use App\Domain\PerencanaanPengadaan\Http\Policies\PengadaanPolicy;
use App\Domain\PerencanaanPengadaan\Http\Policies\PesananPembelianPolicy;
...
use App\Domain\Platform\Http\Policies\PenyediaLayananOrganisasiPolicy;
...
final class PolicyServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        Gate::policy(PenyediaLayananOrganisasi::class, PenyediaLayananOrganisasiPolicy::class);
        ...
        Gate::policy(PesananPembelian::class, PesananPembelianPolicy::class);
        Gate::policy(PenerimaanPembelian::class, PenerimaanPembelianPolicy::class);
