 ...
 *
 * Yang dikirim ke browser hanya apa yang diperlukan untuk menggambar dan
 * mengisi formulir. Konfigurasi internalnya — webhook, pemicu otomasi, tag,
 * kampanye — tidak pernah ikut: itu urusan server, dan halaman publik dapat
 * dibaca siapa saja.
 */
final class PenyusunFormulirPublik
{
    ...
    public function susun(FormulirPemasaran $formulir): array
    {
        ...
        return [
            ...
            // Hanya dikirim saat CAPTCHA memang menyala, supaya halaman biasa
            // tidak ikut memuat skrip pihak ketiga tanpa keperluan.
