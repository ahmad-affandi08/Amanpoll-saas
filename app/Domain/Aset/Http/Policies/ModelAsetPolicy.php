...
final class ModelAsetPolicy
{
    ...
    public function update(Pengguna $pengguna, ModelAset $modelAset): bool
    {
        return $this->izin->boleh($pengguna->Id, 'Aset.Ubah');
    }

    public function delete(Pengguna $pengguna, ModelAset $modelAset): bool
    {
