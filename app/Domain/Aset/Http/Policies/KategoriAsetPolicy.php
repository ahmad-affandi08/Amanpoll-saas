...
final class KategoriAsetPolicy
{
    ...
    public function update(Pengguna $pengguna, KategoriAset $kategoriAset): bool
    {
        return $this->izin->boleh($pengguna->Id, 'Aset.Ubah');
    }

    public function delete(Pengguna $pengguna, KategoriAset $kategoriAset): bool
    {
