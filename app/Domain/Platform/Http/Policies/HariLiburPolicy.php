...
final class HariLiburPolicy
{
    ...
    public function update(Pengguna $pengguna, HariLibur $hariLibur): bool
    {
        return $this->izin->boleh($pengguna->Id, 'Pengaturan.Kelola');
    }

    public function delete(Pengguna $pengguna, HariLibur $hariLibur): bool
    {
        return $this->izin->boleh($pengguna->Id, 'Pengaturan.Kelola');
    }
}
